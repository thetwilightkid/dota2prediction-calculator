...
export const groupStagePickBansMeta = {
  "note": "Same picks/bans_made/bans_against shape as team_pick_ban_stats.json, but computed ONLY from the 109 real TI2026 Group Stage matches (league_id 19719) - raw unweighted counts, not recency/tier-weighted, since all matches here are from the same event. The original blended file is untouched; this is an additive, isolated view.",
  "group_stage_league_id": 19719,
  "matches_included": 109
};

export const groupStagePickBans: Record<string, GSTeamDrafts> = {
  "2163": {
